...
namespace MyEvernote.Common.Helpers
{
    public class MailHelper
    {
        ...
        public static void SendMailForAbout(string body)
        {
            var fromAddress = new MailAddress("makalemre1125@gmail.com", "Makalemre.com Geribildirim");
            var toAddress = new MailAddress("makalemre1125@gmail.com");
            const string subject = "Makalemre.com Geribildirim";
            using (var smtp = new SmtpClient
            {
                Host = "smtp.gmail.com",
                Port = 587,
                ...
                Credentials = new NetworkCredential(fromAddress.Address, "makalemre1125makalemre1125")
